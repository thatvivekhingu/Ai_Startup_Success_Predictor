...
const DEFAULT_DEALS = [
  {
    ...
    round: "Series C",
    lead_investors: "Creaegis, MNI VenturesΓÇôClaypond Capital, Sentinel Global",
    ...
    summary: "Emergent achieved $1.5B unicorn status raising $130M Series C co-led by Creaegis and MNI VenturesΓÇôClaypond Capital with major participation from Khosla Ventures, SoftBank Vision Fund 2, Lightspeed, and Y Combinator.",
    badge: "AI Unicorn",
  ...
  },
  {
    ...
    source_title: "Reuters ΓÇö River Mobility $120M Funding",
    ...
    secondary_source_title: "TechCrunch ΓÇö River Funding Analysis",
  ...
  },
  {
    ...
    source_title: "ET ΓÇö Udaan $160M Structured Financing",
  ...
  },
  {
    ...
    source_url: "https://retail.economictimes.indiatimes.com/news/e-commerce/e-tailing/udaan-announces-160-million-structured-financing-blackrock-likely-to-invest-45-million/132393474",
    source_title: "ET ΓÇö Udaan BlackRock $45M Credit",
  ...
  },
  {
    ...
    source_title: "TechCrunch ΓÇö Zepto Mega Round",
  ...
  },
  {
    ...
    source_title: "Economic Times ΓÇö PhysicsWallah $210M",
  ...
  },
  {
    ...
    source_title: "Reuters ΓÇö Lenskart $200M Funding",
      ...
      <div className="max-w-7xl mx-auto space-y-10">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="space-y-4 max-w-3xl">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-semibold tracking-wide uppercase">
                ...
                Live Institutional Deal Flow ΓÇó Verified Sources
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-8 border-t border-slate-800/60">
            <div className="bg-slate-800/40 border border-slate-700/40 rounded-xl p-3.5">
              ...
              <span className="text-[11px] text-emerald-400 flex items-center gap-1 mt-0.5">
                ΓùÅ Emergent, River, Udaan, Yotta
              </span>
            </div>
            <div className="bg-slate-800/40 border border-slate-700/40 rounded-xl p-3.5">
              ...
              <span className="text-[11px] text-blue-400 flex items-center gap-1 mt-0.5">
                ΓùÅ Khosla, SoftBank, Lightspeed
              </span>
            </div>
            <div className="bg-slate-800/40 border border-slate-700/40 rounded-xl p-3.5">
            ...
            <div className="bg-slate-800/40 border border-slate-700/40 rounded-xl p-3.5">
              ...
              <span className="text-[11px] text-slate-400 flex items-center gap-1 mt-0.5">
                ΓùÅ Reuters, ET, TechCrunch, Emergent
              </span>
            </div>
          </div>
        </div>
                ...
                <tbody className="divide-y divide-slate-800">
                  {deals.map((deal) => (
                    <tr key={deal.id || deal.startup_name} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-4 px-6 max-w-xs">
                        <p className="text-xs text-slate-400">{deal.existing_investors || 'ΓÇö'}</p>
                      </td>
                      <td className="py-4 px-6">
                        <a
                          href={deal.source_url}
        ...
        <div className="bg-slate-900/50 border border-slate-800/80 rounded-2xl p-6 text-xs text-slate-400 space-y-3">
          ...
          <div className="flex flex-wrap gap-4 pt-2 text-[11px] text-slate-400">
            <span>ΓÇó Emergent Series C ($130M co-led by Creaegis & MNI-Claypond)</span>
            <span>ΓÇó River Mobility Series C ($120M led by Elev8 & Claypond with Yamaha)</span>
            <span>ΓÇó Udaan Structured Financing ($160M) & Private Credit (~$45M BlackRock)</span>
            <span>ΓÇó Yotta Data Services (~$150M Sovereign GPU Infrastructure)</span>
          </div>
        </div>
